...
#define DISPLAY_WIDTH DISPLY_WIDTH
#define DISPLAY_HEIGHT DISPLY_HEIGHT

#define SCREEN_TILE_WIDTH ((DISPLY_WIDTH + TILE_SIZE - 1) / TILE_SIZE)
#define SCREEN_TILE_HEIGHT ((DISPLY_HEIGHT + TILE_SIZE - 1) / TILE_SIZE)
...
#define DISPLY_HEIGHT_QUARTER (DISPLY_HEIGHT/4)
#define DISPLY_HEIGHT_THREE_QUARTERS (DISPLY_HEIGHT*3/4)

#define DISPLY_HEIGHT_MINUS_16 (DISPLY_HEIGHT - 16)
#define DISPLY_HEIGHT_MINUS_32 (DISPLY_HEIGHT - 32)

#define TILE_SIZE 32
#define PLAYER_HEIGHT 32
#define PLAYER_WIDTH 32

#define SCREEN_SCROLL_THRESHOLD_LOW (DISPLY_HEIGHT/2)
#define SCREEN_SCROLL_THRESHOLD_HIGH (DISPLY_HEIGHT*3/4)
#define SCREEN_SCROLL_OFFSET 16
