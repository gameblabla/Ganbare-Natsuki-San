...
{
	snprintf(path, path_size, "/media/data/local/home/.ganbare/config");
}

void Filesystem_GetSaveFolderPath(char *path, size_t path_size)
{
	snprintf(path, path_size, "/media/data/local/home/.ganbare");
}
...
{
	snprintf(path, path_size, "/media/data/local/home/.ganbare/work.sav");
}

void Filesystem_GetItemSavePath(char *path, size_t path_size)
{
	snprintf(path, path_size, "/media/data/local/home/.ganbare/item_wk.sav");
}
